...
import com.example.pixelshop.ui.home.component.CategoryTabRow
import com.example.pixelshop.ui.home.component.Error
import com.example.pixelshop.ui.home.component.HomeScreenTopBar
import com.example.pixelshop.ui.home.component.Loading
import com.example.pixelshop.ui.home.component.ProductList
import com.example.pixelshop.ui.home.component.SearchAppBar
...
fun SuccessScreen(
    ...
    LaunchedEffect(key1 = pagerState) {
        snapshotFlow { pagerState.currentPage }.collect { page ->
            onEvent(ProductScreenEvent.OnCategoryChange(category = categoryUiData[page]))
        }
    }

    LaunchedEffect(key1 = Unit) {
        if (state.searchQuery.isNotEmpty()) {
            onEvent(ProductScreenEvent.OnSearchQueryChanged(searchQuery = state.searchQuery))
        }
    }
                ...
                Column {
                    SearchAppBar(
                        ...
                        onInputValueChange = { newValue ->
                            onEvent(ProductScreenEvent.OnSearchQueryChanged(newValue))
                        },
                        onCloseIconClicked = { onEvent(ProductScreenEvent.OnCloseIconClicked) },
                        onSearchIconClicked = {
                    ...
                    topBar = {
                        HomeScreenTopBar(
                            ...
                            onSearchIconClicked = {
                                ...
                                onEvent(ProductScreenEvent.OnSearchIconClicked)
                            }
                        )
                    }
                ) { padding ->
